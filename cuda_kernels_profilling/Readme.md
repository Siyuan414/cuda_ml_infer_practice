# CUDA Kernel Profiling — Roofline Analysis
This repo implements 4 CUDA kernels and profiles them using Nsight Compute to identify memory vs compute bottlenecks.
- SAXPY: N = 16,777,216
- MatMul Naive / Tiled: N = 512×512
- Softmax: N = 16,777,216
- 
...
Run "ncu --log-file results.txt ./cuda-kernel.exe" to save the profilling results to text file.
